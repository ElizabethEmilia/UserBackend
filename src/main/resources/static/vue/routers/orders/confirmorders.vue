<template>
    ...
    <div class="center">
        <div class="outbox">
            ...
            <img @click="onlinePayMethod=0" :class="['payment',onlinePayMethod==0?'selected':'']" :src="'../../../images/alipay.png'" />
            <img @click="onlinePayMethod=1" :class="['payment',onlinePayMethod==1?'selected':'']" :src="'../../../images/wechat_pay.png'" />
