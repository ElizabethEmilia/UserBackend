...
//    统计税金账户余额,
    ...
    Integer countListGroup(@Param("cid") Integer cid, @Param("yfrom") Date yfrom, @Param("yto") Date yto, @Param("uid") Integer uid);
...
//    税金账户明细
    ...
    Integer countListTaxDetail(@Param("cid") Integer cid, @Param("mfrom") Date mfrom, @Param("mto") Date mto, @Param("uid") Integer uid);
