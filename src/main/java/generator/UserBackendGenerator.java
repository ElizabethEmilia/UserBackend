 ...
 * @Date 2018-08-30
 */
public class UserBackendGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\binbin\\user_backend\\src\\main\\java");//这里写你自己的java目录
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                map.put("abc", this.getConfig().getGlobalConfig().getAuthor() + "-spring-boot");
                this.setMap(map);
            }
        };
        mpg.setCfg(cfg);
